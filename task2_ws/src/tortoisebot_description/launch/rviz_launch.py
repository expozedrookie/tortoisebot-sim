...
def generate_launch_description():
	...
	# dynamically load rviz configuration file - for just showing robot model and TF
	rviz_config_location=LaunchConfiguration('config_file', default=PathJoinSubstitution([FindPackageShare('tortoisebot_description'),'config','rviz.rviz']))
